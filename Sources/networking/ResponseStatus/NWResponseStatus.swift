...
extension NWResponseStatus: Equatable {}

extension NWResponseStatus: Hashable {}

/// A HTTP response status code.
public enum NWResponseStatus: Sendable {
